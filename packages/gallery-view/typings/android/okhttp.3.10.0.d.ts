...
declare module okhttp3 {
  export class CookieJar {
     ...
     */
    public constructor(implementation: { saveFromResponse(param0: okhttp3.HttpUrl, param1: java.util.List<okhttp3.Cookie>): void; loadForRequest(param0: okhttp3.HttpUrl): java.util.List<okhttp3.Cookie>; <clinit>(): void });
    public constructor();
...
declare module okhttp3 {
  ...
  export module EventListener {
    export class Factory {
       ...
       */
      public constructor(implementation: { create(param0: okhttp3.Call): okhttp3.EventListener });
      public constructor();
  ...
  export module HttpUrl {
    ...
    export module Builder {
      export class ParseResult {
        ...
        public static values(): androidNative.Array<okhttp3.HttpUrl.Builder.ParseResult>;
...
declare module okhttp3 {
  export module internal {
    export class Util {
      ...
      public static immutableList(param0: androidNative.Array<any>): java.util.List<any>;
  ...
  export module internal {
    export module http {
      export class HttpCodec {
         ...
         */
        public constructor(implementation: { createRequestBody(param0: okhttp3.Request, param1: number): okio.Sink; writeRequestHeaders(param0: okhttp3.Request): void; flushRequest(): void; finishRequest(): void; readResponseHeaders(param0: boolean): okhttp3.Response.Builder; openResponseBody(param0: okhttp3.Response): okhttp3.ResponseBody; cancel(): void });
        public constructor();
  ...
  export module internal {
    export module http2 {
      export class PushObserver {
         ...
         */
        public constructor(implementation: { onRequest(param0: number, param1: java.util.List<okhttp3.internal.http2.Header>): boolean; onHeaders(param0: number, param1: java.util.List<okhttp3.internal.http2.Header>, param2: boolean): boolean; onData(param0: number, param1: okio.BufferedSource, param2: number, param3: boolean): boolean; onReset(param0: number, param1: okhttp3.internal.http2.ErrorCode): void; <clinit>(): void });
        public constructor();
  ...
  export module internal {
    export module tls {
      export abstract class CertificateChainCleaner {
        ...
        public static get(param0: androidNative.Array<java.security.cert.X509Certificate>): okhttp3.internal.tls.CertificateChainCleaner;
