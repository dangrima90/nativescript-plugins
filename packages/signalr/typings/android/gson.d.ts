	...
	export module google {
		export module gson {
			export class Gson {
				...
				public fromJson(typeAdapter: com.google.gson.stream.JsonReader, e: com.google.gson.reflect.TypeToken<any>): any;
				public constructor();
					...
					export module Gson {
                        export module Gson_B {
                            ...
                            export class Types {
                                ...
                                public static newParameterizedTypeWithOwner(ownerType: java.lang.reflect.Type, rawType: java.lang.reflect.Type, typeArguments: androidNative.Array<java.lang.reflect.Type>): java.lang.reflect.ParameterizedType;
                            ...
                            export module Types {
                                ...
                                export class ParameterizedTypeImpl {
                                    ...
                                    public constructor(length: java.lang.reflect.Type, this_: java.lang.reflect.Type, ownerType: androidNative.Array<java.lang.reflect.Type>);
                                    public toString(): string;
		...
		export module gson {
			export module internal {
				export class ConstructorConstructor {
					...
					public get(this_: com.google.gson.reflect.TypeToken<any>): com.google.gson.internal.ObjectConstructor<any>;
		...
		export module gson {
			export module internal {
				export class GsonBuildConfig {
					...
					public static VERSION: string = "2.11.0";
				}
			}
		}
	}
				...
				export module bind {
					...
					export module MapTypeAdapterFactory {
						export class Adapter<K, V>  extends com.google.gson.TypeAdapter<java.util.Map<any,any>> {
							...
							public constructor();
							public constructor(context: com.google.gson.Gson, keyType: java.lang.reflect.Type, keyTypeAdapter: com.google.gson.TypeAdapter<any>, valueType: java.lang.reflect.Type, valueTypeAdapter: com.google.gson.TypeAdapter<any>, constructor: com.google.gson.internal.ObjectConstructor<any>);
							public write(param0: com.google.gson.stream.JsonWriter, param1: any): void;
				...
				export module bind {
					...
					export module TypeAdapters {
						export class EnumTypeAdapter<T>  extends com.google.gson.TypeAdapter<any> {
							...
							public read(param0: com.google.gson.stream.JsonReader): any;
							public read(in_: com.google.gson.stream.JsonReader): any;
							public constructor(constant: java.lang.Class<any>);
						}
					}
				}
			}
