...
declare function sqlite3_load_extension(db: interop.Pointer | interop.Reference<any>, zFile: string | interop.Pointer | interop.Reference<any>, zProc: string | interop.Pointer | interop.Reference<any>, pzErrMsg: interop.Pointer | interop.Reference<string>): number;
...
interface sqlite3_module {
  ...
  xIntegrity: interop.FunctionReference<(p1: interop.Pointer | interop.Reference<sqlite3_vtab>, p2: string, p3: string, p4: number, p5: interop.Pointer | interop.Reference<string>) => number>;
}
